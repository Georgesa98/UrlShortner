"use client";
import { Pagination, UrlResponse } from "@/api-types";
import {
  ColumnDef,
  flexRender,
  getCoreRowModel,
...
interface FraudDetectionDataTableProps<TData, TValue> {
...
export function FraudDetectionDataTable<TData, TValue>({
  columns,
  data,
  pagination,
  onPageChange,
  onRowClick,
}: FraudDetectionDataTableProps<TData, TValue>) {
  ...
  const table = useReactTable({
    ...
    getRowId: (row) => {
      const urlRow = row as UrlResponse;
      return String(urlRow.id);
    },
  });
